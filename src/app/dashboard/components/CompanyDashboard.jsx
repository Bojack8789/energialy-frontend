...
// CompanyDashboard.jsx — ACTUALIZADO
// Integra los 3 widgets de suscripción arriba del dashboard existente
...
import SubscriptionWidgets from "@/app/components/SubscriptionWidgets"; // ✅ NUEVO
...
function CompanyDashboard({ user }) {
  ...
  return (
    <div>
      <div className="flex">
        <h1 className="flex items-center p-2 text-xl text-gray-400 font-extralight font-jose">
          Hola, {user.firstName}
        </h1>
      ...
      <div className="flex flex-col w-full h-screen gap-3 p-2 rounded-md">
        ...
        {/* ✅ NUEVO: 3 widgets de suscripción arriba del dashboard */}
