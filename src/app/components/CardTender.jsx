...
const CardTender = ({item, isOwn}) => {
  ...
  return (
    <>
    <div className={`rounded-lg bg-white p-4 sm:p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 w-full mb-4 flex flex-col gap-3 ${isOwn ? 'border-2 border-primary-300' : ''}`}>

      {/* Fila superior: empresa, ubicación, presupuesto — y fecha a la derecha */}
