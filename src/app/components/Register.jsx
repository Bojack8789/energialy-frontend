...
export default function Register() {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      displayFailedMessage(error?.response?.data?.error || 'Error al registrar usuario');
    }
  };

  return (
    <div className="min-h-[90vh] flex items-center justify-center px-4 py-8">
      <div className="bg-white shadow rounded w-full max-w-2xl">
        <h3 className="mb-0 p-3 sm:p-4 bg-gray-100 border-b border-gray-300 text-base sm:text-lg">
          Registro de usuario
        </h3>
        <form className="mb-2 px-3 sm:px-4 pt-4">
          ...
          <div className="mb-6 sm:mb-8">
            ...
            {passwordError && (
              <div className="text-danger mt-2 text-sm">{passwordError}</div>
            )}
          </div>
          <div className="mb-6 sm:mb-8">
            ...
            {confirmPasswordError && (
              <div className="text-danger mt-2 text-sm">{confirmPasswordError}</div>
            )}
          </div>
          ...
          <div className="flex justify-center border-t pt-4">
            <button
              type="button"
              className="w-full sm:w-auto px-8 py-2 text-white bg-[#191654] rounded hover:bg-secondary-600 transition duration-300"
